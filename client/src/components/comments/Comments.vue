...
export default defineComponent({
  data() {
    return {
      comments: [],
      posts: [], // Adicione um array de tópicos (ou 'topic_id')
      selectedPost: null, // Armazena o 'topic_id' selecionado
      body: '',
    }
  },
  methods: {
    ...
    async createComment() {
      if (this.selectedPost !== null && this.body.trim() !== '') {
        await api.post("/comments", {
          body: this.body,
          post_id: this.selectedPost, // Adiciona o 'topic_id' ao criar o comentário
        })
        this.clearForm()
        this.loadComments()
      }
